...
class Config {
    ...
    var $defaultDept;   //Departamento por defecto    
    var $defaultEmail;  //Email por defecto 
    var $alertEmail;  //alerta de email
    var $defaultSMTPEmail; //por defecto  SMTP Email
    ...
    //Inicialice algunos valores por defecto.
    function init(){
    ...
    function setMysqlTZ($tz){
        //TODO: Combine el 2 reemplazar expresiones regulares 
    ...
    function getBaseUrl(){ //Igual que el anterior sin barra inclinada.
    ...
    function saveEmailHeaders() {
        return true; //Ya no es una opción ... pista: grandes planes para los encabezados venir!!
    }
    ...
    /* respuestas automáticas y alertas*/
    ...
    /* Alertas de error enviados al administrador de correo electrónico cuando está habilitado*/
    ...
    //simplemente comprobando si dir destino se usable..nothing que ver con permiso para cargar!
    ...
    function updatePref($var,&$errors) {
        ...
        $f=array();
        $f['helpdesk_url']=array('type'=>'string',   'required'=>1, 'error'=>'Helpdesk URL erforderlich'); //TODO: Añadir validación url
        ...
        $f['time_format']=array('type'=>'string',   'required'=>1, 'error'=>'Formato de hora Requerido'); //TODO: Añadir la validación de formato de fecha  
        ...
        //TODO: comprobar los campos de opciones para la validez.
        ...
        //Somos buenos para ir ... actualización manta!
        ...
        //echo $sql;
        if(db_query($sql)) {
            if(db_affected_rows()) {//Algo cambió en realidad!!!!
                $this->reload();//Actualizar la nueva información.
                require_once(INCLUDE_DIR.'class.cron.php');
                Sys::purgeLogs(); //Liberador de espacio en los registros --- demasiado mal si era una configuración errónea.
                Cron::TicketMonitor(); //tiempo y limpieza
            }
            return true;
        }
        return false;
