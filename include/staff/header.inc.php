...
<div id="container">
    <div id="header">
        <a id="logo" href="index.php" title="osTicket"><img src="images/logo.png" width="188" height="72" alt="osTicket"></a>
        <p id="info">Bienvenido, <strong><?php echo $thisuser->getname()?></strong> <br><?php echo $thisuser->getsignature()?></br>
           <?php 
