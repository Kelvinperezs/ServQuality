...
function toggleLayer(whichLayer) {
    ...
    if( document.getElementById ) // esta es la forma en que las normas funcionan
        elem = document.getElementById( whichLayer );
    else if( document.all ) 
        elem = document.all[whichLayer];
    else if( document.layers ) // esto es las obras 4 manera
        elem = document.layers[whichLayer];
  
    vis = elem.style;
    // iel valor de visualización de estilo está en blanco intentamos averiguarlo aquí
